$(window).load(function () {
    ...
    $.getScript('google-code-prettify/prettify.js');
    ...
    _wikiNavBar.prepend('<a class="scrolltop">↑ Back to top</a>');
    _wikiNavBar.find('a.scrolltop').click( function() {
...
$(window).load(function () {
    ...
    $('pre').addClass('prettyprint').live('mouseover', function() {
